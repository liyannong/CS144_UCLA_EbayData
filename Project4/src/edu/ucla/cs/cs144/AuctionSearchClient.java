...
public class AuctionSearchClient implements IAuctionSearch {
    ...
    public SearchResult[] basicSearch(String query, int numResultsToSkip,
        ...
        //return result;
        return new SearchResult[result.length];
    }
    ...
    public SearchResult[] spatialSearch(String query, SearchRegion region,
        ...
        try {
            ...
            //Set to store valid Items in the search region
            ...
            //Utilize the above method and check their intersection
